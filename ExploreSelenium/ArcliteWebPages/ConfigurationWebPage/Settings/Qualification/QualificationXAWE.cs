...
namespace ExploreSelenium.ArcliteWebPages.ConfigurationWebPage.Settings.Qualification
{
    public class QualificationXAWE : IArcliteData
    {
        ...
        public QualificationXAWE(IArclitePage page)
        {
            ...
            dataTable = new KeyValuePair<string, IArcliteWebElement>("Qualification Data Table", new ArcliteDataTable("Qualification Data Table", search.Value, "//td[text()='", "']/parent::tr", "/td/button", confirmDelete, cancelDelete));
